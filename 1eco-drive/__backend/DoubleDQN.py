...
tf.compat.v1.disable_eager_execution()  # Makes TF 2.x behave like TF 1.x
...
class Qnetwork():
    ...
    def structure(self):
        ...
        init = tf.compat.v1.keras.initializers.glorot_normal()
        ...
        self.h_1_drop = tf.compat.v1.nn.dropout(h_1, rate=0.25)
        ...
        self.h_2_drop = tf.compat.v1.nn.dropout(h_2, rate=0.25)
